...
DepsCop provides three types of rulesets that help you control and manage your project's dependencies. Each ruleset serves a specific purpose and can be used independently or in combination with others.

You can use multiple rules for the same package to create complex dependency policies. Each rule must include a custom message that explains why the rule exists, helping your team understand the reasoning behind dependency restrictions.
...
When using JavaScript or TypeScript, you can export a static configuration object. This approach is similar to JSON export but allows you to use comments and maintain the configuration in your preferred programming language:
